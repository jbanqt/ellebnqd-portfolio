        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <div class="skill-desc">
                    I am an aspiring </br>
                    front-end designer and developer, </br>
                    with experience designing websites </br>
                    using Figma and Adobe XD </br>
                    and coding using </br>
            ...
            <div class="page-content">
                ...
                <div class="skills-wrapper">
                    ...
                    <ul class="tools-content">
                        <li class="tools">
                            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="52" viewBox="0 0 67.754 78.799">
                        ...
                        <li class="tools">
                            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="52" viewBox="0 0 67.751 78.799">
                        ...
                        <li class="tools">
                            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="52" viewBox="0 0 78.772 78.772">
                        ...
                        <li class="tools">
                            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="52" viewBox="0 0 78.913 78.857">
